...
import convert from "@/public/home/converttobrands.svg";
  ...
  return (
    <div className="flex  flex-col lg:flex-row-reverse mt-10 items-center justify-between text-justify">
      <div className="lg:w-1/2" >
        <p className="text-mirch-pink lg:leading-[26px] lg:text-[22px] font-poppins font-semibold text-[16px] leading-[18px]">

    ...
    <Collapsible className="grid gap-4">
      ...
      <CollapsibleContent>
        <div className="-mx-6 grid gap-6 p-6">
          <Link className="group grid h-auto w-full justify-start gap-1" href="/services">
            <div className="text-sm font-medium leading-none group-hover:underline text-black">Services Page</div>

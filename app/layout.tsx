...
import { Inter, Abhaya_Libre, Playfair_Display, Poppins, Lusitana, Roboto, Montserrat, Lato, Be_Vietnam_Pro} from "next/font/google";
import "./globals.css";
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${inter.className} ${abhaya.className} ${playfair.className} ${poppins.className} ${lusitana.className} ${roboto.className} ${lato.className} ${be_vietnam_pro.className} ${montserrat.className}`}>
        <Navbar />
        {children}</body>
    </html>
  );
